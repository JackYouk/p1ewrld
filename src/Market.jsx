...
export default function Market() {
    ...
    return (
        <div style={{ backgroundColor: 'gray', width: '100%', height: '100dvh', position: 'absolute', color: 'white' }}>
            ...
            <div style={{ textAlign: 'center', fontSize: '50px' }}>My Avatars</div>
            <div className="market-nav">
                <div style={{cursor: 'pointer', margin: '5px', textDecoration: 'none'}}>Market</div>
                <div style={{cursor: 'pointer', margin: '5px', textDecoration: 'none'}}>Casino</div>
                <div style={{cursor: 'pointer', margin: '5px', textDecoration: 'none'}}>Auction</div>
                <div style={{cursor: 'pointer', margin: '5px', textDecoration: 'none'}}>Bank</div>
                <div style={{cursor: 'pointer', margin: '5px', textDecoration: 'underline'}}>My Avatars</div>
            </div>
